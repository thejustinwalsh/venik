// Originally ported from Yoga's tests/generated/YGAbsolutePositionTest.cpp
...
test("absolute_layout_percentage_bottom_based_on_parent_height", () => {
  ...
  root_child2.setPositionPercent(Edge.Bottom, 10);
  root.insertChild(root_child2, 2);
  root.calculateLayout(undefined, undefined, Direction.LTR);
...
test("percent_absolute_position_infinite_height", () => {
  ...
  root_child1.setPositionPercent(Edge.Top, 20);
  root_child1.setPositionType(PositionType.Absolute);
  root.insertChild(root_child1, 1);
  root.calculateLayout(undefined, undefined, Direction.LTR);
